...
const CouponBox =({})=>{
  ...
  return(
    <>
    { arrayColumn.map(data=><Box className="courseMainCoupon"><div className="formMainCoupon" style={{display:"flex",flexDirection:"row"}}>
      
      <Box className="couponLeftBox">
        <Typography>₹ 8000 OFF</Typography>
        <Box className="yellowBox"> <Typography style={{marginBottom:"8%"}}><b>DISCOUNT10</b></Typography> </Box>
      </Box>
